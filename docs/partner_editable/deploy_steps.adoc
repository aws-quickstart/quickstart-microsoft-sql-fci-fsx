...
^|http://qs_launch_permalink[Deploy into an existing VPC with AWS Managed Microsoft AD^]
^|http://qs_template_permalink[View template^]

^|http://qs_launch_permalink[Deploy into an existing VPC with self-managed AD^]
^|http://qs_template_permalink[View template^]
|===
+
